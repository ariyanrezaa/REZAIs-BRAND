...
\033[1;91m☞ Auther     : REZA_IS_BRAND
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update REZA_X Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Ariyan_Reza Group')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WellCome To REZA_X')
	    psb('Congratulations REZA_X Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ fuckyoursystem✓')
	    psb('🔓Password ☆ Rezaisbrand✓')
	    psb('Subscrib My Youtube Channel REZA IS BRAND✓')
